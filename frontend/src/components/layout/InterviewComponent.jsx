        ...
        <>
          ...
          <main className={isEmbedded ? "flex-1 flex items-center justify-center p-2 relative z-10 overflow-hidden" : "flex-1 flex items-center justify-center px-4 md:px-6 py-4 md:py-5 relative z-10 overflow-hidden"}>
            <div className="w-full max-w-[1300px] bg-bg-card border border-border-muted rounded-xl p-5 md:p-6 shadow-[0_0_40px_rgba(0,0,0,0.5)] flex flex-col gap-4 md:gap-5 h-full overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-6 flex-1 overflow-hidden">
                {/* Left Column: Question and Tips */}
                <div className="md:col-span-6 flex flex-col gap-4 overflow-hidden h-full">
                  {/* Active Question Box */}
                  <div className="flex-1 bg-bg-base border border-border-muted rounded-lg p-4 flex flex-col min-h-0 overflow-hidden">
                  ...
                  <div className="flex-1 bg-bg-base border border-border-muted rounded-lg p-4 flex flex-col min-h-0 overflow-hidden">
                    ...
                    <ul className="text-[11px] md:text-xs text-text-secondary space-y-1 leading-relaxed overflow-y-auto pr-1 flex-1">
