...
// (previously: components/Skeleton.jsx)
//
// Skeleton screens are the grey shimmer shapes shown while data is loading.
// They give the user a sense of layout before actual content appears.
//
// Exports:
//   Skeleton          → Base shimmer box. Props: className, variant, width, height
//   SkeletonCard      → Pre-built skeleton shaped like a stats card
//   SkeletonTimeline  → Pre-built skeleton for the history timeline list (3 rows)
//   SkeletonTable     → Pre-built skeleton for the history data table (4 rows)
//
// Used by: DashboardComponent, HistoryComponent, ViewReportComponent
// ─────────────────────────────────────────────────────────────────────────────
